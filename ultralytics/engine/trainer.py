...
class Distillation_loss:
    def __init__(self, models, modelt, distiller="CWDLoss"):  # model must be de-paralleled
...
class BaseTrainer:
    ...
    def _setup_train(self, world_size):
        ...
        # if self.Distillation is not None:
        #     distillation_loss = Distillation_loss(self.model, self.Distillation, distiller=self.Distillation_loss)
    ...
    def build_optimizer(self, model, Distillation,name="auto", lr=0.001, momentum=0.9, decay=1e-5, iterations=1e5):
        """
